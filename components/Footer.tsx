...
const reviews: Review[] = [
  {
    ...
    name: 'Sarah M.',
    image: '/image1.webp',
    text: "These wellness products have completely transformed my self-care routine. The quality is exceptional and I love that they're made in small batches. My skin has never felt better!"
  },
  {
    id: 2,
    name: 'Emily R.',
    image: '/image2.webp',
    text: "FIKA Wellness Co. products are absolutely amazing! The essential oils are pure and the herbal blends are so effective. I've been using them for months and I'm a customer for life."
  },
  {
    id: 3,
    name: 'Jessica L.',
    image: '/image3.webp',
    text: 'As someone who values natural products, FIKA has exceeded my expectations. The attention to detail and quality is evident in every product. Highly recommend to anyone looking for premium wellness products.'
  }
]
...
const journalEntries: JournalEntry[] = [
  {
    id: 1,
    title: 'The Power of Self-Care: Why It Matters',
    date: '15 February',
    image: '/image4.webp'
  },
  {
  ...
  {
    id: 3,
    title: 'Creating Your Perfect Self-Care Routine',
    date: '3 Months Ago',
    image: '/image6.webp'
  }
]
  ...
  return (
    <footer className="relative mt-16">
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(to bottom, #ffffff 0%, #ffffff 45%, #f5efef 45%, #f5efef 100%)'
        }}
      />
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16">
           ...
           <div>
            ...
            <div className="flex items-start space-x-4 md:space-x-5 mb-4">
              <div className="relative w-16 h-16 md:w-18 md:h-18 rounded-full overflow-hidden flex-shrink-0 bg-gray-200">
                {activeReview.image ? (
                  <Image
      ...
      {/* BOTTOM STRIP WITH LOGO + PAYMENT ICONS */}
      <div className="bg-[#f5efef] text-gray-900 mt-0 pt-10 pb-10">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4 text-xs font-semibold">
            <div className="px-4 py-2 rounded bg-white/80 border border-gray-300 text-gray-700">
              Mastercard
            </div>
            <div className="px-4 py-2 rounded bg-white/80 border border-gray-300 text-gray-700">
              VISA
