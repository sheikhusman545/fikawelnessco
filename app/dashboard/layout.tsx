    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <div className="flex flex-col h-full">
          {/* Logo */}
          <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-primary-50 via-primary-50/50 to-transparent">
            <Link href="/dashboard" className="flex items-center space-x-3 group">
              <div className="relative">
                <div className="absolute inset-0 bg-primary-200 rounded-xl blur-lg group-hover:blur-xl transition-all"></div>
                <Image
                  src="/logo.webp"
              ...
              <div>
                <span className="text-xl font-bold block text-gray-900 group-hover:text-primary-700 transition-colors">FIKA Wellness</span>
                ...
                <Link
                  ...
                  className={`group flex items-center space-x-3 px-4 py-3.5 rounded-xl transition-all duration-200 relative ${
                    isActive
                      ...
                      : 'text-gray-700 hover:bg-gradient-to-r hover:from-gray-50 hover:to-gray-100 hover:text-primary-700'
                  }`}
                >
                  {isActive && (
                  ...
                  <span className={`font-semibold flex-1 ${isActive ? 'text-white' : 'text-gray-700 group-hover:text-primary-700'}`}>
                    {item.name}
                  </span>
                  {isActive && (
          ...
          <div className="p-4 border-t border-gray-200 bg-gradient-to-r from-gray-50 to-white">
            <Link
              href="/"
              className="flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-gradient-to-r hover:from-primary-50 hover:to-primary-100/50 hover:text-primary-700 transition-all group"
            >
            ...
            <div className="flex items-center space-x-4 ml-auto">
              ...
              <div className="flex items-center space-x-3 pl-4 border-l border-gray-200">
                <div className="hidden sm:block text-right">
                  ...
                  <p className="text-xs text-gray-500">admin@fikawellnessco.ca</p>
                </div>
                <div className="h-11 w-11 rounded-full bg-gradient-to-br from-primary-600 to-primary-700 flex items-center justify-center text-white font-semibold shadow-lg ring-2 ring-white hover:scale-105 transition-transform cursor-pointer">
                  AU
                </div>
              </div>
            </div>
